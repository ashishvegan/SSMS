...
<tr class="labels" style="text-decoration:underline;"><th>Item Name</th><th>Quantity</th><th>Issued By<br>Staff ID</th><th>Date</th><th>Status</th></tr>
<?php
$x=mysqli_query($set,"SELECT * FROM issue");
while($y=mysqli_fetch_array($x))
{
?>
<tr class="labels" style="font-size:14px;"><td><?php echo $y['name'];?></td><td><?php echo $y['quantity'];?></td><td><?php echo $y['sid'];?></td>
